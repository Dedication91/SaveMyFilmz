...
import UIKit
import CoreData
class LoomingReleaseVC: UIViewController {

   
    @IBOutlet weak var activityIndicatir: UIActivityIndicatorView!

    @IBOutlet weak var loomingReleaseCllctionVw: UICollectionView!
    ...
    fileprivate func refreshDataSource(){
       ...
       activityIndicatir.startAnimating()
        FilmRepo.showLoomingRelease{ (films, error) in            
           self.activityIndicatir.stopAnimating()
            ...
            self.films = films!
            self.loomingReleaseCllctionVw.reloadData()
        }
    ...
    fileprivate func createCell(){
        ...
        self.loomingReleaseCllctionVw.register(nibFile, forCellWithReuseIdentifier: "Cell")
    }
...
extension LoomingReleaseVC: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = loomingReleaseCllctionVw.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! FilmCollectionVwCll
