...
class FeaturedVC: UIViewController {
    ...
    @IBOutlet weak var featuredCllctinVwCll: UICollectionView!
    ...
    fileprivate func refreshDataSource(){
        ...
        FilmRepo.showFeatured{ (films, error) in
            ...
            self.films = films!
            self.featuredCllctinVwCll.reloadData()
        }
    ...
    fileprivate func createCell(){
        ...
        self.featuredCllctinVwCll.register(nibFile, forCellWithReuseIdentifier: "Cell")
    }
...
extension FeaturedVC: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = featuredCllctinVwCll.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! FilmCollectionVwCll
